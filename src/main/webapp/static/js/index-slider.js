...
var slideTiming = 5000; // this variable is the time it takes before the slide is changed
...
$("#slider-panel-center-carousel").animate({"top": -(200*(current-1))}, animationTime, "easeInOutExpo");/*修改400px->200px*/
