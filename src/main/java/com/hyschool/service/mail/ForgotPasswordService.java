package com.hyschool.service.mail;
...
public class ForgotPasswordService {
     ...
     */
    public void processForgotPassword(String email,String validateCode){
        ///邮件的内容
        ...
        sbPage.append("<!DOCTYPE html>\n" +
                ...
                "                                </tr>\n" +
                "                                <tr>\n" +
                "                                    <td class=\"message\"><h2>您刚刚请求了重置HySchool的密码，请点击重置密码按钮修改登录密码。</h2>\n" +
                "                                    </td>\n" +
                "                                </tr>\n" +
                "                                <tr>\n" +
                "                                    <td>\n" +
                "                                        <a style=\"text-decoration:none;\" href="+strHref+" class=\"btn\" target=\"_blank\">重置密码</a>\n" +
                "                                    </td>\n" +
                "                                </tr>\n" +
                "                                </tbody>\n" +
                "                            </table>\n" +
