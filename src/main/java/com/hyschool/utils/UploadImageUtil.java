...
public class UploadImageUtil {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(base64ToImageFile(base64EncodeString, ConstantsUtil.VIP_AVATAR_IMAGES_FILEPATH + "test.jpg"));
     ...
     * @return base64字符串
     */
    public static String imageToBase64(String filePath) throws IOException {// 将图片文件转化为字节数组字符串，并对其进行Base64编码处理
        byte[] data = null;
        // 读取图片字节数组
        InputStream in = null;
        try {
     ...
     * @return
     */
    public static boolean base64ToImageFile(String base64EncodeString, String filePath) throws IOException {// 对字节数组字符串进行Base64解码并生成图片
        // 生成jpeg图片
        try {
